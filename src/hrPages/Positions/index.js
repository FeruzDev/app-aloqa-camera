...
const Positions = () => {
    ...
    const createPage = () => {
        history.push("/home/positions/add")
    }
    const editPage = () => {
        history.push("/home/positions/edit")
    }
    ...
    return (
        <div className="users">
                            ...
                            {rows.map((row) => (
                                ...
                                >
                                    <TableCell component="th" scope="row">
                                        <span className="t-name font-family-medium">Должность 1</span>
                                    </TableCell>
            ...
            >
                <p className="pt-2 pb-2">Вы уверены, что удалите этого должности? Это невозможно отменить</p>
            </Modal>
            <Modal title="Внимание!"
                   open={isModalOpen2}
            ...
            >
                <p className="pt-2 pb-2">Вы уверены, что заблокируете этого должности?</p>
            </Modal>
