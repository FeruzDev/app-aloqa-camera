...
const Users = () => {
    ...
    return (
        <div className="users">
                    ...
                    <Table sx={{minWidth: 650}} aria-label="simple table">
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell className="table-head" align="right">Последняя сессия</TableCell>
                            ...
                            {rows.map((row) => (
                                ...
                                >
                                    <TableCell component="th" scope="row">
                                        <span className="t-name font-family-medium">Javohir Hasanov</span>
                                    </TableCell>
                                    <TableCell className="twt" align="right"><span
                                        className="t-name font-family-medium">Admin</span></TableCell>
            ...
            >
                <p className="pt-2 pb-2">Вы уверены, что заблокируете этого пользователя?</p>
            </Modal>
