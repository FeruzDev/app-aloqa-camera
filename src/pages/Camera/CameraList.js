...
const CameraList = () => {
    ...
    const getRooms = (id) => {
        ...
        setSelectOffices(id)
        // setSelectRooms(id)
        axios.get(API_PATH + "company/" + localStorage.getItem('id') + "/room/" + params.room_id + "/all", {headers: {"Authorization": "Bearer " + localStorage.getItem("token")}})
            .then(res => {
    ...
    const getCamerasSelects = () => {
        axios.get(API_PATH + "company/" + localStorage.getItem('id') + "/camera/by/room/" + params.camera_id + "/all", {headers: {"Authorization": "Bearer " + localStorage.getItem("token")}})
            .then(res => {
                setCameras(res.data)
            })
            .catch(err => {
